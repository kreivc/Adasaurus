		...
		>
			<div className="flex flex-wrap relative w-full items-center flex-row mx-auto justify-center space-x-0 md:space-x-10">
				...
				>
					...
					<span className="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-[#01bf71] to-[#46e4a2] md:inline-block md:pb-3 md:pr-1">
						All my friends are dead <br />{" "}
						<span className="text-[#293cc7]">can I share mine</span> with you?
					</span>
				</h1>
			</div>
